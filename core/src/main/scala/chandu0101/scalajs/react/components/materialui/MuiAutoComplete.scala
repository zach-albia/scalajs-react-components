...
case class MuiAutoComplete(
  ...
  popoverProps:             js.UndefOr[js.Object]                                         = js.undefined,
  ...
  def apply(children: VdomNode*) = {
    ...
    val f = JsComponent[js.Object, Children.Varargs, Null](Mui.AutoComplete)
    f(props)(children: _*)
  }
}
...
@js.native
trait MuiAutoCompleteM extends js.Object {
