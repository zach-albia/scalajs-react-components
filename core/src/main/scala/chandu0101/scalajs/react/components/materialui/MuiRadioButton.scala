...
case class MuiRadioButton[T](
  ...
  onCheck:              js.UndefOr[(ReactEvent, T) => Callback]            = js.undefined,
...
implicit def ev2T(t: T | js.Array[T]): js.Any = t.asInstanceOf[js.Any]
    ...
    val f = JsComponent[js.Object, Children.None, Null](Mui.RadioButton)
    f(props)
  }
}
...
@js.native
trait MuiRadioButtonM extends js.Object {
